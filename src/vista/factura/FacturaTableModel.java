...
public class FacturaTableModel implements TableModel {
    ...
    public int getColumnCount() {
        return 5; //ya que tendremos tres valores a mostrar por contacto
    }
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        ...
        switch (columnIndex) {
            ...
            case 2:
                ...
                break;
            case 3:
                value = factura.getImporte() * IVA/100;
                factura.setDescuento((double)value);        
                break;
            case 4: 
                value = factura.getImporte() - factura.getImporte() * IVA/100;
                factura.setTotal((double)value); 
                break;
        }
        return value;
